...
Test(parsing, find_subcommand_ambiguous, .init = setup_ambiguous_parsing)
{
    ...
    cr_assert_eq(test_argus.error_code, 0, "No errors for exact match");
    ...
    cr_assert_neq(test_argus.error_code, 0, "Should report one error for ambiguous match");
    ...
    cr_assert_eq(test_argus.error_code, 0, "No errors for unambiguous partial match");
}
...
Test(parsing, find_subcommand_remove_ambiguity, .init = setup_remove_parsing)
{
    ...
    cr_assert_eq(test_argus.error_code, 0, "No errors for exact match 'remove'");
    ...
    cr_assert_eq(test_argus.error_code, 0, "No errors for exact match 'remove-all'");
    ...
    cr_assert_neq(test_argus.error_code, 0, "Should report one error for ambiguous 'rem' match");
}
