...
int choices_string_validator(argus_t *argus, void *option_ptr, validator_data_t data)
{
    ...
    ARGUS_REPORT_ERROR(argus, ARGUS_ERROR_INVALID_CHOICE, "Value '%s' is not one of the choices",
...
int choices_int_validator(argus_t *argus, void *option_ptr, validator_data_t data)
{
    ...
    ARGUS_REPORT_ERROR(argus, ARGUS_ERROR_INVALID_CHOICE, "Value '%lld' is not one of the choices",
                       option->value.as_int);
}
...
int choices_float_validator(argus_t *argus, void *option_ptr, validator_data_t data)
{
    ...
    ARGUS_REPORT_ERROR(argus, ARGUS_ERROR_INVALID_CHOICE, "Value '%f' is not one of the choices",
